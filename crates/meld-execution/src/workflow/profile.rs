...
pub struct WorkflowProfile {
    ...
    /// Stable historical profile field. Retained only for stored Workflow
    /// inspection; no runtime selector or environment override consumes it.
    /// Remove only after profiles carrying this field are migrated or unsupported.
    #[serde(default, skip_serializing_if = "Option::is_none")]
