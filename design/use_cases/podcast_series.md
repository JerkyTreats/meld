...
- Dimensions mix: teachability and coherence are observational, while audio existence and duration are directly observable facts. How one Goal combines them remains open.
...
6. **Mixed dimension targets.** One Goal target may need to combine observational and directly observable propositions. No transform is currently canonical.
7. **Provider-heavy capacity.** Research, generation, and synthesis quotas and costs may need to flow as capacity facts and cost ceilings. This remains a design hypothesis.
