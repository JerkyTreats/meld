...
`SHIPPING_CENTS` is `500`, and `FREE_SHIPPING_MINIMUM_CENTS` is `9000`. For a nonnegative subtotal below `9000`, shipping costs `500` cents. At `9000` or above, shipping is free.
