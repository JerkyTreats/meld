...
Planner projection is conditionally ready for graph plus belief projection into `meld-lang::WorldState`.
...
- First projection fields must be specified as concrete code contracts.
