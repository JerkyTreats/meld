...
| `src/generation` | 523 | Generation plan and orchestrator | Mixed | Move to `src/context/orchestration` | [Context Domain Structure Spec](context/context_domain_structure.md), [Context Generation Orchestration Spec](context/context_generation_orchestration.md) |
| `src/frame` | 2301 | Frame model storage set and queue runtime | Mixed | Keep frame model and storage. Move queue runtime to `src/context/queue` | [Context Domain Structure Spec](context/context_domain_structure.md) |
