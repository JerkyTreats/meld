...
Use [Branch Feature Implementation Plan](branch_feature_implementation_plan.md), [Branch Federation Substrate](branch_federation_substrate.md), and [Spine Graph Completion Review](spine_graph_completion_plan.md) for current status.
