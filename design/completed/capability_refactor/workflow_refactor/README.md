...
- [Capability Refactor Completion](../README.md)
- [Capability And Task Design](../../../capabilities/README.md)
- [Docs Writer Package](../../../capabilities/task/docs_writer_package.md)
- [Capability And Task Implementation Plan](../../../capabilities/PLAN.md)
- [Interregnum Orchestration](../../../control/interregnum_orchestration.md)
- [Merkle Traversal Technical Spec](../merkle_traversal/technical_spec.md)
