...
Existing version 1.0.0 preparations retain their epoch semantics and original receipt identities. Selecting version 1.1.0 requires a new preparation; this change does not rewrite earlier Agent genesis. The package does not yet connect automatic mitigation selection to the running Security reconciliation path.
