//! Task expansion contracts and append-only delta compilation.
...
fn compile_traversal_prerequisite_expansion(
    api: &ContextApi,
    compiled_task: &CompiledTaskRecord,
    expansion: &TaskExpansionRequest,
    catalog: &CapabilityCatalog,
            ...
            for turn in &content.repeated_region.turns {
                ...
                capability_instances.push(BoundCapabilityInstance {
                    ...
                    binding_values: vec![
                        binding(
                            "persist_frame",
                            json!(turn.turn_id == content.prerequisite_template.producer_turn_id),
                        ),
                        binding("output_type", json!(turn.output_type)),
                    ],
                    input_wiring: vec![
